...
- The most hands-off approach is to send it to Emissary. For a small fee, we'll take the whole job off your hands :) Click the Send to Emissary button on the top right and rest easy, while we comb through every sample and log your metrics.
