---
title: Text Classification (Approach 2)- Guide
---
...
<Card> <img src="/images/guides/NewTrainingJob.png" /> </Card>
...
Uncomment the <span style={{ color: 'red' }}>"sample_match_binary_labels_metric"</span> to use it.
